...
(function (global, factory) {
  ...
  function Arrows(Splide2, Components2, options) {
    ...
    function createArrow(prev2) {
      ...
      if (prev2 === true) {
        arrow = "<button class=\"" + "\"  type=\"button\"><div><img class='imgButton' src='../media/imgs/splide/prev1.svg'/></div>";
      }

      if (prev2 === false) {
        arrow = "<button class=\"" + "\" type=\"button\"><div><img class='imgButton' src='../media/imgs/splide/next1.svg'/></div>";
      }
